...
Сделай капсулу и скриншоты! Трейлеры смотрят мало, большинство из тех, кто смотрит, — секунды три, проматывают скрины, идут дальше.
...
❌ Не нужно подробно рассказывать про сюжет и сеттинг — если только это не самый главный элемент игры.
...
### Размеры графических ассетов

<span class="stamp stamp--date">актуально на 2026-07</span> Размеры — из официального [Graphical Assets в Steamworks](https://partner.steamgames.com/doc/store/assets). Валидатор в партнёрке не пропустит файл другого размера, так что готовь сразу по списку.

| Слот | Размер | Где виден |
|---|---|---|
| Header capsule | 920×430 | шапка страницы игры, вишлист, выдача поиска |
| Small capsule | 462×174 | списки, результаты поиска, топы |
| Main capsule | 1232×706 | крупные баннеры на главной и на страницах распродаж |
| Vertical capsule | 748×896 | вертикальные подборки и промо-блоки |
| Page background | 1438×810 | фон страницы игры |
| Library capsule | 600×900 | библиотека игрока |
| Library hero | 3840×1240 | шапка игры в библиотеке |
| Library logo | 1280×720 | логотип поверх library hero |
| Скриншоты | от 1920×1080, 16:9 | галерея на странице |

Многие слоты показываются игроку сильно уменьшенными — проверяй капсулу в мелком масштабе, а не только в 100%: название должно читаться, а жанр угадываться.

### Что Valve запрещает размещать на капсуле

<span class="stamp stamp--date">правила в силе с 1 сентября 2022</span> На базовой капсуле допустимы только арт, название игры и официальный подзаголовок. [Правила Steamworks](https://partner.steamgames.com/doc/store/assets/rules) прямо запрещают:

- **оценки прессы** — любые, в любом виде;
- **награды** — названия, символы и логотипы премий;
- **маркетинговый текст** — «-50%», «On Sale Now», «Now with multiplayer»;
- **промо других продуктов** — реклама сиквелов, DLC и чужих игр на капсуле базовой игры.

Требования к самой капсуле: читаемое название/логотип игры, точный размер, контент не жёстче PG-13.

<div class="cl cl-warn" markdown>

Нарушение стоит видимости: Valve ограничивает показ игры на промо-поверхностях магазина, пока капсула не приведена в порядок.

Есть легальная лазейка — **временное перекрытие (artwork override)** под крупный апдейт, сезонное событие или DLC. Условия жёсткие: не дольше месяца, локализовано на все языки игры и рассказывает только про новый контент.

</div>

Собрать ассеты по размерам помогает [Steam Asset Creator](../07-tools/index.md) — он нарезает комплект из исходников.
...
- Используй заранее подготовленные заголовки-картинки вместо текстовых заголовков;
...
**Что Valve запрещает в тексте описания** <span class="stamp stamp--date">правила с сентября 2024</span>

Правила касаются и краткого описания, и About This Game. За нарушение страницу разворачивают на review, а если проскочило — Valve правит текст сам. Нельзя:

- **ссылки и упоминания других игр в Steam** — ни текстом, ни картинкой, ни виджетом. Раньше встречались страницы, начинавшиеся со списка чужих игр студии; теперь это прямо запрещено;
- **внешние ссылки** — включая замаскированные («DOTA2 DOT COM») и QR-коды. Для соцсетей есть отдельные поля страницы;
- **графику, подделывающую интерфейс Steam** — фальшивые кнопки «Wishlist»/«Buy now», чужие капсулы, наложенные ценники;
- **текст с привязкой ко времени** — «Now Available», «Available on March 4th», «Prepurchase now». Описание живёт годами, а такие фразы протухают.

Технический лимит там же: все картинки и гифки описания вместе — до 15 МБ, каждая — до 5 МБ.

Продвигать свои другие игры можно, но не в описании: для этого есть [страница разработчика](https://partner.steamgames.com/doc/store/devpublisherpages), франшиза и паки. Источник: [Store Page Written Description, Steamworks](https://partner.steamgames.com/doc/store/page/description).
...
Виджет "Похожие игры" (Games like this) — это блок внизу страницы игры в Steam. Он показывает другим игрокам проекты, связанные с текущей игрой алгоритмически или вручную. Этот виджет влияет на органический трафик и виральность, особенно в ранние фазы продвижения.
