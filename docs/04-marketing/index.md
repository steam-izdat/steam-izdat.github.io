...
Даже отличная игра без внимания и охвата не попадёт ни в алгоритмы, ни в рекомендации. *Маркетинг — то, что приносит первые вишлисты и внимание к проекту*.
...
- **Popular Upcoming ужесточился** — теперь собирает в основном *крупные* ожидаемые релизы. Нижняя планка подскочила с ~6–7 тыс до порядка **100–120 тыс вишлистов** <span class="stamp stamp--date">оценка на 2026-07</span>. Это наблюдение сообщества по выборке вышедших игр, *не объявленный Valve порог* — Valve его не раскрывал и не раскроет, оценки разных наблюдателей расходятся (весной 2026 говорили про ~80 тыс). Порядок величины важнее точного числа: попасть стало примерно в 15 раз труднее, и для большинства инди раздел фактически закрылся. Пруфы: [разбор Chris Zukowski](https://howtomarketagame.com/), [PCGuide](https://www.pcguide.com/news/steams-new-100000-wishlist-rule-means-many-indie-devs-will-have-to-rely-on-a-different-feature-to-be-discovered/), [games.gg](https://games.gg/news/steam-popular-upcoming-indie-personal-calendar/).
...
**Ты в Early Access — у тебя есть второй заход в календарь.** <span class="stamp stamp--date">актуально на 2026-07</span> С февраля 2026 в Steamworks у EA-игр появился выбор планируемой даты релиза 1.0: **Edit Store Page → вкладка Early Access**, внизу date picker. Точность выбираешь сам — от размытого срока до конкретного дня. После сохранения и публикации дата показывается на странице магазина в блоке Early Access **и попадает в персональные календари игроков**.

То есть игра, уже вышедшая в EA, снова оказывается в том самом Personal Calendar — как предстоящий релиз. Для инди, которому Popular Upcoming закрыт, это редкая вторая точка входа на главную.

Оборотная сторона: дату видят все, и перенос — публичный. Valve прямо оговаривает, что наличие поля само по себе не повод его заполнять. Ставь дату, только если ты и так называешь её игрокам и уверен в ней.

Источник: [документация Steamworks по Early Access](https://partner.steamgames.com/doc/store/earlyaccess).
...
8–14 месяцев до релиза — идеальное время, чтобы открыть страницу игры на Steam. Так запускаешь накопление вишлистов, без которых не будет ни нормальной видимости в Steam, ни участия в фестивалях.
...
| 🎁 Демка | Запуск публичной демо-версии игры, лучше до фестиваля Steam Next Fest. Отдельная страница демо не обязательна — [почему обычно хватает кнопки](festivals.md). |
...
**Выход демо стал самостоятельным инфоповодом.** <span class="stamp stamp--date">актуально на 2026-07</span> С апдейта вишлистов 23 июля 2026 игрок может подписаться на уведомление «вышло демо» по играм из своего списка желаемого, а на карточке появляется отметка «Demo Available». Раньше выкатка демо проходила тихо и о ней узнавали только те, кто сам зашёл на страницу.

Что это меняет на практике: демо теперь можно выпускать отдельным событием, а не только «под Next Fest» — оно само достучится до части вишлистнувших. Одна игра — один Next Fest, а демо — сколько угодно поводов.

Официальные анонсы Valve: [про вишлисты](https://store.steampowered.com/news/app/593110/view/710028372767410959) · [про гифтинг](https://store.steampowered.com/news/app/593110/view/669497052089025104). <span class="stamp stamp--check">пересказ сверен по [Game Developer](https://www.gamedeveloper.com/pc/steam-adds-wishlist-categories-and-cross-region-gifting); тело анонсов на страницах Steam машинно не читается — при возможности сверься глазами</span>
...
Тематические и ежегодные фестивали игр — очень важный, а часто ещё и бесплатный инструмент продвижения. Обрати на них внимание и прочитай отдельную статью.
...
- 📢 [Каналы продвижения](promotion-channels.md) — где рекламировать игру и ссылки на сервисы и агенства.
