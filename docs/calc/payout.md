...
🧪 **Калькулятор в бете.** Логика свежая — возможны ошибки и упрощения. Бери результат как ориентир, а не как точную бухгалтерию. Нашёл ошибку или недочёт — напиши в [чат STEAMиздат](https://t.me/+71EnXbVVfg83MzUy), поправим.
