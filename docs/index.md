...
<div class="izd-cover__body" markdown>

<p class="izd-cover__kicker">полевой мануал · издание 2026</p>

# STEAMиздат

<p class="izd-cover__tagline">Как издать игру в Steam — для усталого инди, который чинит билд в два часа ночи. Регистрация, банки, маркетинг, цены.</p>
...
<img class="izd-cover__mascot" src="assets/logo.png" alt="Маскот STEAMиздат" width="160" height="160">
...
<div class="izd-sections" markdown>

- :material-rocket-launch-outline:{ .izd-ic } [Старт](01-start/index.md)<span>Регистрация, слот $100, W-8BEN, первая страница «Coming Soon».</span>
...
- :material-bullhorn-outline:{ .izd-ic } [Продвижение](04-marketing/index.md)<span>[Маркетинг](04-marketing/index.md) · [Страница в Steam](04-marketing/store-page.md)  · [Каналы продвижения](04-marketing/promotion-channels.md) · [Фестивали](04-marketing/festivals.md) · [Статистика](06-statistics/index.md)</span>
...
<summary>Сколько стоит опубликоваться?</summary>
...
<details class="izd-faq" markdown>
<summary>Чем оплатить слот, если карта РФ не проходит?</summary>
...
<details class="izd-faq" markdown>
<summary>Какой банк примет выплату от Valve?</summary>
...
<details class="izd-faq" markdown>
<summary>Физлицом или ИП регистрироваться из РФ?</summary>
...
<details class="izd-faq" markdown>
<summary>Как убрать 30% налога США?</summary>
...
<details class="izd-faq" markdown>
<summary>Сколько вишлистов нужно к релизу?</summary>
...
<details class="izd-faq" markdown>
<summary>Когда выпускать демо и за сколько открывать страницу?</summary>
...
:material-book-open-variant: **Библия маркетинга.** У сообщества STEAMиздат есть два больших открытых документа по маркетингу инди на Steam — структурированный справочник и живой авторский сборник. Анонс игры, фестивали, вишлисты, Reddit, письма блогерам, маркетинг по жанрам — весь накопленный опыт. [Что в каждом и куда идти за вопросом → Библия маркетинга](04-marketing/marketing-bible.md).

Авторов много — это сборники опыта разных участников, поэтому на один и тот же вопрос там нередко встречаются разные, иногда противоположные рекомендации. Это нормально: бери их как набор проверенных практик, а не как единственно верную инструкцию — что сработало у одного, не обязательно сработает у тебя.
